...
<head>
    ...
    <title>Workouts — Admin Panel</title>
...
<body class="page-workouts" data-page="workouts">
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="main-area">
                <header class="top-navbar">
                    <h1 class="navbar-page-title">Workouts</h1>
                ...
                <main class="main-content">
                    <div class="page-header">
                        <h2 class="page-title">Workout Plans</h2><button type="button" class="btn btn-primary"><span class="material-icons">add</span> Add Plan</button>
                    </div>
                    <section class="cards-grid">
                        <div class="plan-card content-card">
                            <div class="plan-card-accent"></div>
                            <div class="plan-card-icon"><span class="material-icons">fitness_center</span></div>
                            <h3 class="plan-card-title">Beginner Full Body</h3>
                            <p class="plan-card-desc">4 weeks • 3 days/week</p><button type="button" class="btn btn-ghost">View</button>
                        </div>
                        <div class="plan-card content-card">
                            <div class="plan-card-accent"></div>
                            <div class="plan-card-icon"><span class="material-icons">directions_run</span></div>
                            <h3 class="plan-card-title">HIIT Cardio</h3>
                            <p class="plan-card-desc">2 weeks • 5 days/week</p><button type="button" class="btn btn-ghost">View</button>
                        </div>
                        <div class="plan-card content-card">
                            <div class="plan-card-accent"></div>
                            <div class="plan-card-icon"><span class="material-icons">self_improvement</span></div>
                            <h3 class="plan-card-title">Strength Builder</h3>
                            <p class="plan-card-desc">8 weeks • 4 days/week</p><button type="button" class="btn btn-ghost">View</button>
                        </div>
                        <div class="plan-card content-card">
                            <div class="plan-card-accent"></div>
                            <div class="plan-card-icon"><span class="material-icons">pool</span></div>
                            <h3 class="plan-card-title">Core & Flexibility</h3>
                            <p class="plan-card-desc">6 weeks • 3 days/week</p><button type="button" class="btn btn-ghost">View</button>
                        </div>
                    </section>
                </main>
            </div>
