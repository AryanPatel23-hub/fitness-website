...
<body class="page-users" data-page="users">
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="main-area">
                <header class="top-navbar">
                    <h1 class="navbar-page-title">Users</h1>
                    ...
                    <div class="page-header">
                        ...
                        <div class="page-actions">
                            <div class="search-input-wrap">
                                ...
                                <input type="text" class="search-input" id="usersSearch" placeholder="Search users...">
                            </div>
                            <button type="button" class="btn btn-primary"><span class="material-icons">add</span> Add User</button>
                        </div>
                    </div>
