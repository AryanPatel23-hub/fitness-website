...
<head>
    ...
    <title>Trainers — Admin Panel</title>
...
<body class="page-trainers" data-page="trainers">
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="main-area">
                <header class="top-navbar">
                    <h1 class="navbar-page-title">Trainers</h1>
                ...
                <main class="main-content">
                    <div class="page-header">
                        <h2 class="page-title">Trainer List</h2><button type="button" class="btn btn-primary"><span class="material-icons">add</span> Add Trainer</button>
                    </div>
                    <section class="cards-grid trainer-cards">
                        <div class="trainer-card content-card">
                            <div class="trainer-card-avatar"><img src="https://i.pravatar.cc/120?u=t1" alt="Alex"></div>
                            <h3 class="trainer-card-name">Alex Morgan</h3>
                            <p class="trainer-card-spec">Strength & Conditioning</p>
                            <button type="button" class="btn btn-ghost">View Profile</button>
                        </div>
                        <div class="trainer-card content-card">
                            <div class="trainer-card-avatar"><img src="https://i.pravatar.cc/120?u=t2" alt="Jordan"></div>
                            <h3 class="trainer-card-name">Jordan Lee</h3>
                            <p class="trainer-card-spec">HIIT & Cardio</p>
                            <button type="button" class="btn btn-ghost">View Profile</button>
                        </div>
                        <div class="trainer-card content-card">
                            <div class="trainer-card-avatar"><img src="https://i.pravatar.cc/120?u=t3" alt="Sam"></div>
                            <h3 class="trainer-card-name">Sam Taylor</h3>
                            <p class="trainer-card-spec">Yoga & Flexibility</p>
                            <button type="button" class="btn btn-ghost">View Profile</button>
                        </div>
                        <div class="trainer-card content-card">
                            <div class="trainer-card-avatar"><img src="https://i.pravatar.cc/120?u=t4" alt="Casey"></div>
                            <h3 class="trainer-card-name">Casey Kim</h3>
                            <p class="trainer-card-spec">Nutrition & Diet</p>
                            <button type="button" class="btn btn-ghost">View Profile</button>
                        </div>
                    </section>
                </main>
