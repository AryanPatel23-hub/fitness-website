        ...
        <div class="dashboard-wrapper">
            ...
            <div class="main-area">
                <header class="top-navbar">
                    <h1 class="navbar-page-title">Blog</h1>
                ...
                <main class="main-content">
                    <div class="page-header">
                        <h2 class="page-title">Blog Posts</h2><button type="button" class="btn btn-primary"><span class="material-icons">add</span> New Post</button>
                    </div>
                    <section class="content-card">
                        <div class="table-wrap">
                            <table class="data-table blog-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>10 Tips for Better Sleep</td>
                                        <td>Admin</td>
                                        <td>Feb 15, 2025</td>
                                        <td><span class="badge badge-active">Published</span></td>
                                        <td><button type="button" class="btn-icon btn-edit" title="Edit"><span class="material-icons">edit</span></button><button type="button" class="btn-icon btn-delete" title="Delete"><span class="material-icons">delete</span></button></td>
                                    </tr>
                                    <tr>
                                        <td>Beginner's Guide to HIIT</td>
                                        <td>Admin</td>
                                        <td>Feb 12, 2025</td>
                                        <td><span class="badge badge-active">Published</span></td>
                                        <td><button type="button" class="btn-icon btn-edit" title="Edit"><span class="material-icons">edit</span></button><button type="button" class="btn-icon btn-delete" title="Delete"><span class="material-icons">delete</span></button></td>
                                    ...
                                    <tr>
                                        <td>Meal Prep Sunday Ideas</td>
                                        <td>Admin</td>
                                        <td>Feb 10, 2025</td>
                                        <td><span class="badge badge-inactive">Draft</span></td>
                                        <td><button type="button" class="btn-icon btn-edit" title="Edit"><span class="material-icons">edit</span></button><button type="button" class="btn-icon btn-delete" title="Delete"><span class="material-icons">delete</span></button></td>
                                    </tr>
                                    <tr>
